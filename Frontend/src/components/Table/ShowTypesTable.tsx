...
const ShowTypesTable = ({isAddIem}) => {
  ...
  const handleDeleteItem = async () => {
    try {
      const response = await axios.delete(`${apiLink}/admin/show-type/${item.id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleUpdateItem = async () => {
    try {
      ...
      const response = await axios.patch(`${apiLink}/admin/show-type/${item.id}`,
        body,
        {
          headers: {
            Authorization: `Bearer ${token}`,
